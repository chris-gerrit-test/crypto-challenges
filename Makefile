...
q23:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set3/q23.c -o bin/q23
	bin/q23

q24:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set3/q24.c -o bin/q24
	bin/q24

q25:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set4/q25.c -o bin/q25
	bin/q25 < data/set1/7.txt

q26:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set4/q26.c -o bin/q26
	bin/q26

q27:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set4/q27.c -o bin/q27
	bin/q27

q28:
	$(CC) $(CFLAGS) -I $(INCLUDE) $(LIBCRYPTO) src/set4/q28.c -o bin/q28
	bin/q28
